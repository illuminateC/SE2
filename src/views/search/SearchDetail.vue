...
<!--                  </button>-->
                ...
                <div class="search-result__sort-right">
                  ...
                  <!-- 每页尺寸 -->
                  <div class="per-page">
                    <span class="per-page-label">每页页数： </span>
...
const allEntitySortType = {
  "works": ["相关度↓", "发表时间↑", "发表时间↓", "被引↓"],
  "authors": ["相关度↓", "发布作品↓", "发布作品↑", "被引↓"],
};
...
const buildSortKey = () => {
  ...
  if (searchStore.searchType === "works") {
    ...
    // 此时就要 重置 排序方式
    if (searchStore.sortType === "发布作品↓" || searchStore.sortType === "发布作品↑") {
      searchStore.sortType = "相关度↓";
    }
    ...
    // 此时就要 重置 排序方式
    if (searchStore.sortType === "发表时间↑" || searchStore.sortType === "发表时间↓") {
      searchStore.sortType = "相关度↓";
    }
    switch (searchStore.sortType) {
      case "相关度↓":
